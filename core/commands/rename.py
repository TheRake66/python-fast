...
def parse_rename(subparsers: _SubParsersAction[ArgumentParser]) -> None:
  parser: ArgumentParser = subparsers.add_parser(ActionType.RENAME,
    help="Renomme un élément existant.")
  parser.add_argument("type", type=ItemType, choices=list(ItemType), 
    help="Type d'élément.")
  parser.add_argument("old", type=str,
    help="Nom de l'élément existant.")
  parser.add_argument("new", type=str,
    help="Nouveau nom de l'élément.")
