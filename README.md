...
The `web-app.json` settings file is included as an example. It allows you to develop a web application with [this](https://github.com/TheRake66/templates-web-app) templates.
